...
public class Player {
	...
	public void draw(Graphics2D g, GameWindow f) {
	...
	public void setMainWindow(GameWindow w) {
	...
	private boolean isItTouchingSide(Point p,GameWindow w) {
	...
	public Point isOnEdgeOfWindow(GameWindow w) {
