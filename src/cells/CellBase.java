...
public abstract class CellBase {
	...
	static Connector[] compedium= {new Connector('0',a->new Air()),new Connector('1',a->new Stone()),new Connector('2',a->new Goal()),new Connector('3',a->new SpawnPoint()),new Connector('4',a->new NotSplitableRock())};
